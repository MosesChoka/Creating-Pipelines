Pipelines are a way to keep data preprocessing and modeling organized. Pipelines bundles up the preprocessing and modeling steps to run them as a single command.
